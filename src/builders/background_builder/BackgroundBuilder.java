package builders.background_builder;
...
public class BackgroundBuilder extends JFrame
{
	public static void main(String[]args) {
		...
		SwingUtilities.invokeLater(() -> {
			BackgroundBuilder build = new BackgroundBuilder(data);
	...
	public BackgroundBuilder(DataContainer data) {
		this.data = data;
