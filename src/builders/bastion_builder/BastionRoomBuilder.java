...
public class BastionRoomBuilder extends JFrame
{
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(()->{
			BastionRoomBuilder frm = new BastionRoomBuilder(data);
			frm.setVisible(true);
		});
	}
	...
	public BastionRoomBuilder(DataContainer data)
	{
		this.data = data;
		...
		this.addWindowListener(CompFactory.createSafeExitWindowListener(this, this.data));
		this.pack();
	}
